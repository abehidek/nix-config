...
with lib;
let 
  cfg = config.hm-modules.desktop.hyprland;
  swaylock = "${pkgs.swaylock-effects}/bin/swaylock";
  swaybg = "${pkgs.swaybg}/bin/swaybg";
  inherit (config.hm-modules.desktop) wallpaper;
in {
  imports = [
    inputs.hyprland.homeManagerModules.default
  ];
  options.hm-modules.desktop.hyprland = {
    rice = mkEnableOption false;
  };

  config = mkIf cfg.rice {
